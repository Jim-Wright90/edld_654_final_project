...
With 1% of the data extracted, the model obtained a RMSE of 96.5%. Larger samples of data were extracted to explore how the change in sample size would impact the model. Running the model with 7% of the data reduced the RMSE to 91.5%, while running the model with 10% and 15% of the data both reduced the RMSE to 91.1%. To be consistent with all the models used for the final project, the final model was run with 7% of the data. 